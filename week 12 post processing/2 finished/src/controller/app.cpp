...
void App::set_up_opengl() {
	...
	shaders.push_back(make_shader(
		...
		"../src/shaders/fragment.txt"));
	shaders.push_back(make_shader(
		"../src/shaders/vertex_post.txt", 
		"../src/shaders/fragment_post.txt"));
	...
	depthbuffer = factory.build_depthbuffer(window);
	framebuffer = factory.build_framebuffer(colorbuffer, depthbuffer);
}
...
void App::make_systems() {
    ...
    renderSystem = new RenderSystem(shaders, window, transformComponents, 
		renderComponents, animationComponents, framebuffer);
	postSystem = new PostSystem(shaders[3], colorbuffer);
}
